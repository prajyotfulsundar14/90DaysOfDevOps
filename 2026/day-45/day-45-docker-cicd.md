...
[Docker-Hub](https://hub.docker.com/repository/docker/devopsprajyot/webapp/general)
...
6. Run the container: `docker run -d --name web -p 80:80 devopsprajyot/webapp:latest`